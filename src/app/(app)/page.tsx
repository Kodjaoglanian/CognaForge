    ...
    <div>
      ...
      <Card className="mt-12 bg-gradient-to-br from-card to-muted/30 border-primary/20 shadow-lg">
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            No CognaForge, acreditamos que o aprendizado é uma aventura contínua, uma forja onde 
            suas habilidades intelectuais são moldadas e fortalecidas. Cansado de métodos passivos? 
            Mergulhe em experiências interativas projetadas para desafiar, engajar e expandir sua 
            capacidade de pensar, argumentar e criar.
          </p>
          <p>
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3 list-none pl-0">
            <li className="flex items-start">
              <StickyNote className="h-5 w-5 mr-2 mt-0.5 text-primary flex-shrink-0"/> 
              <span><span className="font-medium text-foreground/90">Organize</span> suas ideias, <span className="font-medium text-foreground/90">resuma</span> e <span className="font-medium text-foreground/90">cocrie</span> com o Caderno IA e seu Assistente de Escrita.</span>
            </li>
            <li className="flex items-start">
              <Lightbulb className="h-5 w-5 mr-2 mt-0.5 text-primary flex-shrink-0"/> 
              <span><span className="font-medium text-foreground/90">Clarifique</span> o complexo e <span className="font-medium text-foreground/90">desmistifique</span> o obscuro.</span>
            </li>
            <li className="flex items-start">
              <FileText className="h-5 w-5 mr-2 mt-0.5 text-primary flex-shrink-0"/> 
              <span><span className="font-medium text-foreground/90">Analise</span> textos profundos e <span className="font-medium text-foreground/90">extraia</span> a essência.</span>
            </li>
            <li className="flex items-start">
              <Puzzle className="h-5 w-5 mr-2 mt-0.5 text-primary flex-shrink-0"/> 
              <span><span className="font-medium text-foreground/90">Construa</span> conhecimento com mapas mentais e anotações inteligentes.</span>
            </li>
            <li className="flex items-start">
              <Swords className="h-5 w-5 mr-2 mt-0.5 text-primary flex-shrink-0"/> 
              <span><span className="font-medium text-foreground/90">Desafie</span> suas convicções em duelos argumentativos.</span>
            </li>
            <li className="flex items-start">
              <Brain className="h-5 w-5 mr-2 mt-0.5 text-primary flex-shrink-0"/> 
              <span><span className="font-medium text-foreground/90">Navegue</span> pelos vieses cognitivos e <span className="font-medium text-foreground/90">afie</span> seu julgamento.</span>
            </li>
            <li className="flex items-start">
              <ClipboardCopy className="h-5 w-5 mr-2 mt-0.5 text-primary flex-shrink-0"/> 
              <span><span className="font-medium text-foreground/90">Memorize</span> com flashcards gerados sob medida.</span>
            </li>
          </ul>
          <p className="pt-2 font-semibold text-foreground/90">
            A cada desafio, a cada conceito desvendado, a cada entrevista simulada, você não está apenas 
            aprendendo – você está forjando uma mente mais ágil, crítica e poderosa. Prepare-se para 
            desbloquear seu potencial máximo.
          </p>
        </CardContent>
        <UiCardFooter>
          <p className="text-sm text-center w-full text-muted-foreground">CognaForge - Afiando mentes, um desafio de IA por vez.</p>
        </UiCardFooter>
      </Card>
    </div>
  );
